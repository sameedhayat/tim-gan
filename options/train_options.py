...
class TrainOptions:
    def __init__(self):
        ...
        self.parser.add_argument(
            "--w_gate", type=float, default=1.0, help="weight of the gate variance loss"
        )
        self.parser.add_argument(
            "--num_adablock", type=int, default=4, help="Number of adaptive res blocks"
        )
        self.parser.add_argument(
            "--gan_mode", type=str, default="lsgan", help="gan_mode"
        )
        self.parser.add_argument(
            "--pretrain",
            type=str,
            default="",
            help="load model file pre-trained with reconstruction",
        )
        ...
        self.parser.add_argument(
            "--n_ep", type=int, default=60, help="number of epochs"
        )
